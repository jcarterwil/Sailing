...
export const MIN_MAKING_WAY_SOG_KTS = 1; // shared polar/performance TWA eligibility
...
export const PERFORMANCE_CALCULATION_VERSION = "performance-v1.3.0";
...
export const PERFORMANCE_MAX_BEST_INTERVAL_KTS = 50;
...
/** Deterministic opportunity contract bounds and materiality thresholds (#89). */
export const PERFORMANCE_OPPORTUNITY_MAX_PRIMARY = 3;
export const PERFORMANCE_OPPORTUNITY_MAX_OBSERVATIONS = 3;
export const PERFORMANCE_OPPORTUNITY_MAX_SUPPRESSED = 16;
export const PERFORMANCE_OPPORTUNITY_MAX_EVIDENCE = 8;
export const PERFORMANCE_OPPORTUNITY_MAX_ASSUMPTIONS = 6;
export const PERFORMANCE_OPPORTUNITY_MAX_CAVEATS = 6;
export const PERFORMANCE_OPPORTUNITY_MAX_TEXT_CHARS = 240;
export const PERFORMANCE_OPPORTUNITY_MIN_SECONDS = 2;
export const PERFORMANCE_OPPORTUNITY_MIN_VMG_KTS = 0.5;
export const PERFORMANCE_OPPORTUNITY_TIE_KTS = 0.01;
export const PERFORMANCE_OPPORTUNITY_ASYMMETRY_KTS = 0.25;
export const PERFORMANCE_OPPORTUNITY_CONSISTENCY_IQR_KTS = 0.75;
export const PERFORMANCE_MARK_RECOVERY_WINDOW_SECONDS = 20;
...
/** A timer-seeded finish cluster must exceed this share of all canonical entries. */
export const PERFORMANCE_COURSE_INFERRED_FINISH_MIN_SUPPORT_RATIO = 0.5;
/** Timer-seeded finish approaches must remain inside this refined cluster spread. */
export const PERFORMANCE_COURSE_INFERRED_FINISH_MAX_SPREAD_M = 75;
/** Short gap-free neighborhood used to distinguish a moving finish approach from a stationary endpoint. */
export const PERFORMANCE_COURSE_INFERRED_FINISH_MOVEMENT_WINDOW_MS = 5_000;
/** Minimum net displacement required on each side of a timer-seeded closest approach. */
export const PERFORMANCE_COURSE_INFERRED_FINISH_MIN_MOVEMENT_M = 2;
